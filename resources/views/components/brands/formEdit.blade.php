<form id="form_update_brand" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="PUT"
      action="{{ route('marcas.update', $brand->id) }}" data-table="#brands-table">
    <div class="mb-13 text-center">
        <h1 id="titleForm" class="mb-3">Editar Marca</h1>
    </div>
    <div class="row">
        <div class="col-12 d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
            ...
            <input type="text" class="form-control form-control-solid" placeholder="Digite o nome da Marca"
        ...
        <div class="col-12 d-flex flex-column mb-8 fv-row fv-plugins-icon-container">
            ...
            <select name="active" id="active" class="form-select form-select-solid" data-control="select2"
                    data-placeholder="Selecione uma opção" data-dropdown-parent="#form_update_brand">
                <option></option>
                <option @selected($brand->active == 1) value="1">Sim</option>
                <option @selected($brand->active == 0) value="0">Não</option>
            </select>
        </div>
    </div>
